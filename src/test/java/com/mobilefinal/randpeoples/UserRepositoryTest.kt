...
private val user1 = User("Duman", "Marlambekov", "Astana", "http://..")
private val user2 = User("Erasyl", "Usen", "Astana", "http://..")
private val user3 = User("Zhangir", "Bayanov", "Astana", "http://..")
...
class MockUserDao : UserDao {
    ...
    private val users = MutableLiveData(listOf(user1, user2, user3));
